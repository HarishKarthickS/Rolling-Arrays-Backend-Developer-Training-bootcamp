...
DATABASE_URL = "postgresql://neondb_owner:npg_1vCa9jgAnWQr@ep-rough-truth-a1t0j1ye-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require"

# Use PostgreSQL (Neon) for all environments
DATABASES = {
...
# Use WhiteNoise storage backend for efficient static file serving in production
